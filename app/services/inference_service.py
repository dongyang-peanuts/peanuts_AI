...
def _disease_ranking_kor(text: str, age_hint: Optional[int] = None) -> List[Tuple[str, float]]:
    ...
    CANDIDATES = {
    "고혈압": [4.0, ["혈압", "고혈압", "두통", "어지럼"]],
    "당뇨병": [4.0, ["당뇨", "혈당", "고혈당", "저혈당", "다뇨", "다음", "피로"]],
    "치매": [3.5, ["기억력 저하", "인지 저하", "섬망", "혼돈", "방향감 상실"]],
    "골다공증": [3.5, ["골다공증", "골절", "낙상", "허리 통증"]],
    "뇌졸중(중풍)": [5.0, ["편측마비", "언어장애", "구음장애", "시야장애", "갑작스러운 마비"]],
    "심부전": [4.0, ["호흡곤란", "부종", "야간호흡곤란", "체중 증가", "피로"]],
    "관상동맥질환(협심증/심근경색)": [4.0, ["가슴통증", "흉통", "압박감", "호흡곤란"]],
    "만성폐쇄성폐질환(COPD)": [3.5, ["기침", "가래", "호흡곤란", "천명음"]],
    "폐렴": [3.5, ["기침", "가래", "열", "호흡곤란", "산소포화도 저하"]],
    "요로감염": [4.0, ["배뇨통", "빈뇨", "절박뇨", "탁뇨", "소변 냄새", "열"]],
    "신부전(만성콩팥병)": [3.5, ["신부전", "부종", "소변 감소", "혈크레아티닌 상승"]],
    "파킨슨병": [4.0, ["손 떨림", "경직", "느린 움직임", "보행 불안정"]],
    "우울증": [3.0, ["우울", "의욕 저하", "불면", "식욕 저하", "피로"]],
    "불안장애": [2.5, ["불안", "긴장", "불면", "가슴 답답"]],
    "빈혈": [3.0, ["피로", "창백", "어지럼", "호흡곤란"]],
    "변비": [2.5, ["배변", "변비", "딱딱한 변", "배불름"]],
    "탈수": [3.5, ["탈수", "구갈", "피부 건조", "저혈압"]],
    "욕창": [4.0, ["피부손상", "발적", "압박", "궤양", "욕창"]],
